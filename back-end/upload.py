...
llm_results_df = pd.read_csv('Hillary_Ronen-H.csv')
...
llm_results_df.to_sql('Hillary_Ronen-H', con=engine, index=False, if_exists='append')
...
print('Csv data has been written to the database.')
