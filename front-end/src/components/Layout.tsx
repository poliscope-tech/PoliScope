...
// }) {
//   // useId is a hook, ensure that it's being used within a functional component or another hook.
//   let id = useId()
...
//           <div className="sm:pt-50 pb-40 pt-6 sm:pb-20 lg:py-10 lg:pt-10">
//             <div className="relative">
//               {main}
//               {/* Place the avatars within this container */}
//               <div className="flex justify-center space-x-4 lg:absolute lg:right-0 lg:top-0 lg:mr-5 lg:mt-10">
//                 <img
